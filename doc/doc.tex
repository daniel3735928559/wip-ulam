...
\cite{regularity_criterion_finch} Finch's criterion for regularity

\cite{regularity_schmerl} Schmerl and Speigel prove of regularity for $U(2, 2n+3)$
...
ultimately periodic \cite{sumfree_cameron}.  The converse is believed to be false,
...
has given a sort of converse to this example, proving in \cite{sumfree_regularity_luczak} that
...
A construction of Cameron and Erdos in
\cite{irregular_sumfree_cameron} supplies an example of a sum-free set
with density $\frac13$ that has no periodicity, namely: Take
$\alpha \in \R$ irrational, and let $A_\alpha$ be the set of integers
$n$ such that $n \mod{\alpha}$ lies in
$[\frac \alpha 3, \frac {2\alpha}{3}]$.  $A_\alpha$ is clearly
...
\bibitem{irregular_sumfree_cameron} 
Cameron Erdos
