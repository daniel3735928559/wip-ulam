...
*******  Computing lambda for other sequences

*******  Rationality of lambda

*******  Algebraicity of lambda

******  What is the spectrum?

*******  U(1,2) has spectrum alpha Z

*******  Same for other Ulam sequences, sum-free sets

*******  Construction of sum-free set with spectrum alpha Z, beta Z--connection between spectrum and density

******  What is the distribution?

*******  Distribution for sum-free sets as well

*******  Circle method: No Ulam numbers close to 0 mod lambda?

******  Density

*******  Conjecture: Ulam numbers have positive density

*******  Conjecture: Decision sequence for sum-free set has positive density implies sum-free set does also

******  Difference between Ulam and sum-free

*******  Distribution of small summands

*******  Distribution of large summands

*******  Distribution of complements

******  Theorem: Almost sum-free implies at least one large Fourier coefficient

******  Variants of the Ulam problem

\subsection{The large Fourier coefficient $\alpha$}

We noted above that if $A$ is the set of Ulam numbers, it appears that
for some $\alpha \in \R$ it seems $\widehat{1_{A_N}}(\alpha) \approx
0.8$, where $\alpha \approx 2.5716$.  
