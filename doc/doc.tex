...
$\lambda$ and computing the average value of $r_{A+A}(x)$
for $x$ ranging over integers congruent to $a$ modulo $\lambda$.
Plotting these for various sequences we get the plots: 
...
\begin{tabular}[c]{@{}c@{}}\includegraphics[scale=0.3]{../figs/exp6_u1_3.png}
  \\ $\ulam{1}{3}$\end{tabular} \\
\begin{tabular}[c]{@{}c@{}}\includegraphics[scale=0.3]{../figs/exp6_u1_4.png}
  \\ $\ulam{1}{4}$\end{tabular} &
\begin{tabular}[c]{@{}c@{}}\includegraphics[scale=0.3]{../figs/exp6_u1_11.png}
  \\ $\ulam{1}{11}$\end{tabular} \\
...
\begin{tabular}[c]{@{}c@{}}\includegraphics[scale=0.3]{../figs/exp6_10010.png}
  \\ $\theta(10010)$\end{tabular} \\ 
\end{tabular}

Now, the benefit of studying $r_{A+A}(x)$ is that, being a
convolution, we understand its Fourier transform.  More precisely,
truncate $A$ at $N$ and view $r_{A_N + A_N}(x)$ and $r_{A_N - A_N}(x)$
as functions on $\Z/2N$.  Then
$(\dft_{2N}r_{A_N + A_N}) = (\dft_{2N}A_N)^2$ and
...
unable to prove) is always small:
...
The statement that this error term is small 
