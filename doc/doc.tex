...
\begin{proof}
  ...
  $a \mod{\lambda}$ lying in $(0, \frac{\lambda}{12})$, and a $b$ with
  $b \mod{\lambda}$ in $(\frac{11\lambda}{12},\lambda)$, and a $c$ with
  $c \mod{\lambda}$ in $(\frac\lambda 3, \frac\lambda 2)$.  
  ...
  third, it cannot be a sum of two other elements in the middle
  third.  
\end{proof}
